...
import { CategoryTable } from "./subcategory-table";
import { AddCategoryDialog } from "./add-subcategory-dialog";
import { EditCategoryDialog } from "./edit-subcategory-dialog";
import { DeleteCategoryDialog } from "./delete-subcategory-dialog";
...
export default function SubCategoriesPage() {
  ...
  const fetchCategories = async () => {
    try {
      setIsLoading(true);
      const response = await fetch(`${url.api}/api/subcategories?category_id=${categoryId}`);
      if (!response.ok) {
  ...
  const handleAddCategory = async (formData: FormData) => {
    ...
    try {
      ...
      const response = await fetch(`${url.api}/api/subcategories`, {
        method: "POST",
        headers: {
  ...
  const handleEditCategory = async (formData: FormData) => {
    ...
    try {
      ...
      const response = await fetch(
        `${url.api}/api/subcategories/${selectedSubcategory.subcategory_id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
